...
bind = $shiftMod, Space, changegroupactive
...
# group submap
bind = $shiftMod, T, submap, group
submap = group
binde = ,right, moveintogroup, r
binde = ,left, moveintogroup, l
binde = ,up, moveintogroup, u
binde = ,down, moveintogroup, d
bind = ,escape,submap,reset
submap=reset
